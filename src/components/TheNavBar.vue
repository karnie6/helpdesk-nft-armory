<template>
  <nav class="navbar navbar-expand-lg">
      <div class="container" style="margin-left: 0px">
        <a class="fw-bold text-decoration-none primary-color" style="font-size: 24px" href="/">GMneedhelp's Crypto Concierge</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="d-flex">
            <div class="d-flex align-items-center">
              <a class="fs-6 text-decoration-none primary-color" style="padding-right: 20px" target="_blank" href="https://forms.gle/su9RdDGJmFm5pHr97">Apply to answer questions</a>
            </div>
            <div class="d-flex align-items-center">
              <ConfigPane />
            </div>
