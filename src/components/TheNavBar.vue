<template>
  <nav class="navbar navbar-expand-lg">
      <div class="container">
        <a class="fw-bold text-decoration-none primary-color" style="font-size: 24px" href="/">Crypto Concierge</a>
        ...
        <div id="navbarSupportedContent">
          ...
          <div class="d-flex">
            <div class="d-flex align-items-center">
              <a class="fs-6 text-decoration-none primary-color" style="padding-right: 20px" target="_blank" href="https://discord.gg/CT9KtEfn6V">Join our Community</a>
            </div>
            <div class="d-flex align-items-center">
              <ConfigPane />
            </div>
